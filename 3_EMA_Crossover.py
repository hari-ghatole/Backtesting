...
class FirstStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.ema_short = bt.indicators.ExponentialMovingAverage(
            self.datas[0], period=self.params.period_short)
        self.ema_medium = bt.indicators.ExponentialMovingAverage(
            self.datas[0], period=self.params.period_medium)
        self.ema_long = bt.indicators.ExponentialMovingAverage(
            self.datas[0], period=self.params.period_long)
    ...
    def stop(self):
        print(("EMA_S," + str(self.params.period_short) + ",EMA_M," + str(self.params.period_medium)+",EMA_L," +
               str(self.params.period_long)+",Profit/Loss," + str(int(self.broker.getvalue()-10000000.00))))
        # print(self.mylog)
